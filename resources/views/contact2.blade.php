              ...
              <ul class="nav nav-inline">
                ...
                <li class="nav-item dropdown">
                  ...
                  <a class="dropdown-item" href="{{ url('/about-us') }}">About Us</a>
                    <a class="dropdown-item" href="{{ url('/about-us2') }}">About Us 2</a>
                    <a class="dropdown-item" href="{{ url('/team-page') }}">Team Members</a>
                    <a class="dropdown-item" href="{{ url('/services') }}">Services</a>
                    <a class="dropdown-item" href="{{ url('/service2') }}">Services 2</a>
                    <a class="dropdown-item" href="{{ url('/contact1') }}">Contact Us</a>
                    <a class="dropdown-item" href="{{ url('/contact2') }}">Contact Us 2</a>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">                      
                    ...
                    <a class="dropdown-item active" href="contact2.html">Contact us 2</a>
                  </div> 
                </li>          
    ...
    function initialize() {
      var mapOptions = {
        ...
        styles: [{
          ...
          ;
      map = new google.maps.Map(document.getElementById('google-map-contact2'), mapOptions);
      addMarker();
