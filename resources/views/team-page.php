...
<html lang="en">
  ...
  <!-- Header area wrapper starts -->
    ...
    <div class="container">
      <div class="myPage">
      <p class="writeup">Diabetes mellitus is a disorder in which the amount of sugar in the blood is elevated. Doctors often use the full name diabetes mellitus, rather than diabetes alone, to distinguish this disorder from diabetes insipidus. Diabetes insipidus is a relatively rare disorder that does not affect blood glucose levels but, just like diabetes mellitus, also causes increased urination. Diabetes mellitus is a disease that prevents your body from properly using the energy from the food you eat. Diabetes occurs in one of the following situations. Check your blood sugar level today.</p>  
      <div class="content-inner-2">
      <h2 class="check">Blood sugar</h2>  
      <p class="team"> The three major nutrients that make up most food are carbohydrates, proteins, and fat. Sugars are one of three types of carbohydrates, along with starch and fiber.</p>
      <p class="level">There are many types of sugar. Some sugars are simple, and others are complex. Table sugar (sucrose) is made of two simpler sugars called glucose and fructose. Milk sugar (lactose) is made of glucose and a simple sugar called galactose. The carbohydrates in starches, such as bread, pasta, rice, and similar foods, are long chains of different simple sugar molecules. Sucrose, lactose, carbohydrates, and other complex sugars must be broken down into simple sugars by enzymes in the digestive tract before the body can absorb them.</p>
      <p class="my-details">Once the body absorbs simple sugars, it usually converts them all into glucose, which is an important source of fuel for the body. Glucose is the sugar that is transported through the bloodstream and taken up by cells. The body can also make glucose from fats and proteins. Blood "sugar" really means blood glucose.</p>
</div>
</div>
