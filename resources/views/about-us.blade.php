...
<html lang="en">
  ...
  <!-- Header area wrapper starts -->
              ...
              <ul class="nav nav-inline">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">                      
                    ...
                    <a class="dropdown-item" href="{{ url('/team-page') }}">Team Members</a>
                    <a class="dropdown-item" href="{{ url('/services') }}">Services</a>             
                    <a class="dropdown-item" href="{{ url('/contact1') }}">Contact Us</a>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">                      
                    <a class="dropdown-item" href="{{ url('/accordions') }}">Accordions</a>
                    <a class="dropdown-item" href="{{ url('/tabs') }}">Tabs</a>
                    <a class="dropdown-item" href="{{ url('/buttons') }}">Buttons</a>
                    <a class="dropdown-item" href="{{ url('/skills') }}">Progress Bars</a>
                    <a class="dropdown-item" href="{{ url('/testimonials') }}">Testimonials</a>
                    <a class="dropdown-item" href="{{ url('/team') }}">Team</a>
                    <a class="dropdown-item" href="{{ url('/carousel') }}">Carousel</a>
                    <a class="dropdown-item" href="{{ url('/maps') }}">Google Maps</a>
                  </div> 
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="container-fluid">
      ...
      <p><strong>Etox</strong> is an online medical resource that delivers comprehensive, well-researched, and quality content on general health, wellbeing, fitness, exercise and lifestyle to its audience. Articles posted on this website are mainly for educational purposes and should never be adopted as bases for diagnoses of underlying conditions.</p>
        <p>We encourage our readers to seek immediate medical attention from qualified physicians for persisting health concerns.</p>
        </div>
</div>
</div>
</div>
 <!-- Page Header End -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="images">
              <img src="assets/img/about/Happy-min.png" alt="">
            </div>
          </div>
          <div class="col-md-8 col-sm-6 col-xs-12">
            <div class="content-inner">
              <h2 class="title">A healthy diet sustains life, Eat healthy to stay healthy.</h2>
    ...
    <!-- Clients Section -->
    <section id="clients" class="section split">
      <!-- Container Ends -->
      <div class="container">
          ...
          <div class="col-md-12">
            <div class="cta-area">
              <div class="cta-content text-xs-center">
                <h2 class="wow slideInLeft" data-wow-delay="0.1s">Engage - Multipurpose Bootstrap 4 Template</h2>
                <p class="wow slideInRight" data-wow-delay="0.2s">Perfect Choice for you next business website</p>
                <a href="#" class="btn btn-common wow fadeInUp" data-wow-delay="0.5s"><i class="fa fa-download"></i> Download Now</a>
              </div>
            </div>
          </div>
        </div>
