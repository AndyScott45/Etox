...
">
      <div class="container">
          ...
          <div class="content-inner-1">
                <h2 class="my-blog">HEALTH</h2>
                <p class="lead">Health as a state of complete physical, mental and social well-being and not merely the absence of disease or infirmity- <a target="_self" href="https://www.who.int/about/who-we-are/constitution" style="color:#0040ff; text-decoration:underline"> World Health Organization 1946</a>. This definition of health according to the W.H.O is all emcompassing, as it states clearly that apart from the absence of diseases, the individual must be in a state of complete, physical, mental and social well-being. </p><p class="lead">Please click <a href="http://127.0.0.1:8000/login" style="color:#FF1493; text-decoration:underline">Login</a> to log into your account, or Sign up new account to gain access to highly reviewed medical contents on this site.</p>
            </div>
          </div>
          <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="images">
              <img src="assets/img/about/gym.png" alt="">
            </div>
          </div>
      </div>         
    </div>
          ...
          <div class="row">
            <div class="col-md-6 col-sm-6">
              <p class="copyright-text">
                ©  2016 Engage. All right reserved. Designed with by <a href="#">etox</a>
              </p>
            </div>
            <div class="col-md-6  col-sm-6">
